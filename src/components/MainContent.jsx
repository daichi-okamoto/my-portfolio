...
import { faTwitter } from '@fortawesome/free-brands-svg-icons'; // Twitterアイコンを使う場合
  ...
  return (
    ...
    >
      ...
      >
        ...
        <section>
          <div className='w-3/4 mx-auto tracking-widest my-20 xl:my-28'>
            <p className='text-sm md:text-base lg:text-lg xl:text-xl font-bold text-black'>岡本 能知</p>
            <div className='flex justify-between items-center'>
              <h2 className='text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-widest text-black'>DAICHI OKAMOTO</h2>
            ...
            <div className='border-b border-black my-20'></div>
            <div className='flex justify-center items-center space-x-6'>
              <a href="https://github.com/daichi-okamoto" className='text-header text-3xl hover:opacity-70 duration-300'><FontAwesomeIcon icon={faGithub} /></a>
              <a href="https://x.com/rq_rb_engineer" className="hover:opacity-70 duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className='w-8 fill-current text-header' >
